...
<body>
        ...
        <div class="contenido">
            ...
            <div class="texto">
                <p id="que-es">
                    ...
                    Aliquam dolores, iure totam, suscipit modi accusamus iusto ea
                    maiores ab natus rerum at cupiditate necessitatibus eveniet quae
                    sunt accusantium recusandae dolor!
                </p>
                ...
                <a class="link-dom" href="#" data-id="1" data-description="Document Object Model">DOM</a>
                <section class="cards">
                    <figure class="card">
    ...
    <script src="../../public/assets/js/dom/atributosdata.js" type="text/javascript"></script>
</body>
</html>